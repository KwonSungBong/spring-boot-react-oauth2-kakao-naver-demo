...
public class CustomOAuth2AccessTokenResponseHttpMessageConverter extends AbstractHttpMessageConverter<OAuth2AccessTokenResponse> {
    ...
    protected Converter<Map<String, String>, OAuth2AccessTokenResponse> tokenResponseConverter =
            new CustomOAuth2AccessTokenResponseHttpMessageConverter.OAuth2AccessTokenResponseConverter();

    protected Converter<OAuth2AccessTokenResponse, Map<String, String>> tokenResponseParametersConverter =
            new CustomOAuth2AccessTokenResponseHttpMessageConverter.OAuth2AccessTokenResponseParametersConverter();
